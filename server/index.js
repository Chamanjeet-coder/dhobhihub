...
const uri = "mongodb+srv://asd:asd123@dhobi-hub.31tq8xs.mongodb.net/";


const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });

client.connect((err) => {
	const orders = client.db('dhobihub').collection('order');
...
client.connect((err) => {
	const products = client.db('dhobihub').collection('products');
