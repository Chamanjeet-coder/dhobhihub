            ...
            <Container>
                <Row className="py-3">
                    <Col md={6} className="py-3">
                        ...
                        <h4 className="text-danger">dhobihub Online Laundry Service</h4>
                        <p className="text-white">Email: dhobihub.support@gmail.com</p>
                        <p className="text-white">Phone: +9189-6380-79309</p>
                    </Col>
                ...
                <div className='footer-bottom d-flex justify-content-center'>
                    <p className='text-secondary'>Copyright &copy; 2023</p>
                </div>
            </Container>
        </footer>
    );
