			...
			<Row className="my-2">
				<Col md={6}>
					...
					<div>
						...
						<div className="terms mb-5">
							...
							<li className="mt-3">
								Minimum Order Amount is INR 100 for free pick and drop service, otherwise you have to
								pay additional INR 20 as charge.
							</li>
						</div>
					</div>
				</Col>
				...
				<Col md={6} className="mobileView">
					...
					<p className="text-justify story ml-5">
						Dhobhihub help you find laundry service near you and ensure that your clothes ar led by
